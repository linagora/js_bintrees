...
function(a){for(var c=this.lowerBound(a),b=this._comparator;0===b(c.data(),a);)c.next();return c};f.prototype.min=function(){var a=this._root;if(null===a)return null;for(;null!==a.left;)a=a.left;return a.data};f.prototype.max=function(){var a=this._root;if(null===a)return null;for(;null!==a.right;)a=a.right;return a.data};f.prototype.iterator=function(){return new g(this)};f.prototype.eachNode=function(a){for(var c=this.iterator(),b,d=0;null!==(b=c.next());)a(b,d),d++};f.prototype.each=function(a){this.eachNode(function(c,
b){a(c.data,b)})};f.prototype.mapNode=function(a){for(var c=this.iterator(),b,d=[],e=0;null!==(b=c.next());)d.push(a(b,e)),e++;return d};f.prototype.map=function(a){return this.mapNode(function(c,b){return a(c.data,b)})};g.prototype.data=function(){return null!==this._cursor?this._cursor.data:null};g.prototype.next=function(){if(null===this._cursor){var a=this._tree._root;null!==a&&this._minNode(a)}else if(null===this._cursor.right){do if(a=this._cursor,this._ancestors.length)this._cursor=this._ancestors.pop();
else{this._cursor=null;break}while(this._cursor.right===a)}else this._ancestors.push(this._cursor),this._minNode(this._cursor.right);return null!==this._cursor?this._cursor:null};g.prototype.prev=function(){if(null===this._cursor){var a=this._tree._root;null!==a&&this._maxNode(a)}else if(null===this._cursor.left){do if(a=this._cursor,this._ancestors.length)this._cursor=this._ancestors.pop();else{this._cursor=null;break}while(this._cursor.left===a)}else this._ancestors.push(this._cursor),this._maxNode(this._cursor.left);
